...
function ShowMsg($msg,$gourl,$onlymsg=0,$limittime=0,$extraJs='')
{
	...
	$htmlhead .= "<base target='_self'/>\r\n<style>body{background:#f9fafd;color:#818181}.mac_msg_jump{width:90%;max-width:624px;min-height:60px;padding:20px 50px 50px;margin:5% auto 0;font-size:14px;line-height:24px;border:1px solid #cdd5e0;border-radius:10px;background:#fff;box-sizing:border-box;text-align:center}.mac_msg_jump .title{margin-bottom:11px}.mac_msg_jump .text{margin-bottom:11px}.msg_jump_tit{width:100%;height:35px;margin:25px 0 10px;text-align:center;font-size:25px;color:#23c319;letter-spacing:5px}</style></head>\r\n<body leftmargin='0' topmargin='0'>\r\n<center>\r\n<script>\r\n";
	$htmlfoot  = "</script>\r\n$extraJs</center>\r\n</body>\r\n</html>\r\n";
	...
	else
	{
      ...
      function JumpUrl(){
		...
		if($onlymsg==0)
		{
			...
			{
				$rmsg .= "<br /><br /><a href='{$gourl}'>如果浏览器没有自动跳转，请点击这里</a>";
			}
			$rmsg .= "<br/></div></div>\");\r\n";
			if($gourl!="javascript:;" && $gourl!='')
			{
